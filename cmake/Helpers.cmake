...
option(LEARNCPP_BUILD_TESTS "Add tests" OFF)
option(LEARNCPP_BUILD_BENCHMARKS "Add benchmark analisys" OFF)
option(LEARNCPP_BUILD_EXAMPLES "Build some examples" OFF)

set(LEARNCPP_PROJECT_ENV "DEV" CACHE STRING "Development environment")
set_property(CACHE LEARNCPP_PROJECT_ENV PROPERTY STRINGS "DEV" "PROD")
message(STATUS "Building for environment: ${LEARNCPP_PROJECT_ENV}")
